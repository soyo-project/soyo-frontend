        ...
        <div class="group-card__members">
          ${(g.members && g.members.length > 0)
            ? g.members.slice(0, 4).map(m => `
                <img class="group-member-avatar" src="${m}" alt="member"
  ...
  function showGroupCode(name, code) {
    ...
    overlay.innerHTML = `
      <div class="group-code-modal">
        <button class="modal-close-btn" onclick="document.getElementById('groupCodeModal').remove()" style="position:absolute;top:16px;right:16px;">✕</button>
